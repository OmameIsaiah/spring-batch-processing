package com.batch.processing.job.jobs;

import com.batch.processing.job.listener.JobCompletionNotificationListener;
import com.batch.processing.job.listener.PersonItemReadListener;
import com.batch.processing.job.model.Person;
import com.batch.processing.job.processor.PersonItemProcessor;
import com.batch.processing.job.tasklets.DeleteInputCsvTasklet;
...
public class CsvToDatabaseJob {
    ...
    @Bean
    public DefaultLineMapper<Person> lineMapper(LineTokenizer tokenizer, FieldSetMapper<Person> mapper) {
